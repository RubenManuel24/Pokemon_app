...
Future<List<Map<String, dynamic>>> getListOfPokemonsData() async {
  ...
  List<Map<String, dynamic>> listOfPokemonsDetailedInformationObjects = [];

  for (Map<String, dynamic> pokemonObjectFromRESTAPI
      in pokemonsFirstObjectsFromRESTAPI) {
    listOfPokemonsDetailedInformationObjects.add(jsonDecode((await http.get(
      Uri.parse(
  ...
  return listOfPokemonsDetailedInformationObjects;
}